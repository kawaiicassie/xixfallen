          ...
          <div className="space-y-1 my-2">
            {!isCollapsed ? (
              <>
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 via-transparent to-transparent rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-0" />
                  <div className="absolute inset-0 w-full h-full bg-[#333] opacity-0 group-hover:opacity-10 transition-opacity duration-300 z-0" />
                  <div className="absolute bottom-0 left-0 h-[1px] bg-gradient-to-r from-transparent via-pink-400 to-transparent w-0 group-hover:w-full transition-all duration-500 z-5" />
                  <div className="relative z-5 flex items-center">
                    <div
                      className={`${isMobile ? "w-6 h-6" : "w-8 h-8"} flex items-center justify-center flex-shrink-0 text-[#f4e8c1] bg-[#1c1c1c] rounded-lg border border-[#333333] shadow-inner transition-all duration-300 group-hover:border-[#444444] group-hover:text-pink-400 group-hover:shadow-[0_0_8px_rgba(244,114,182,0.4)]`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <div className="ml-2 transition-all duration-300 ease-in-out overflow-hidden">
                      <span
                        className={`magical-text whitespace-nowrap block text-xs md:text-sm group-hover:text-pink-400 transition-colors duration-300 ${fontClass}`}
                      >
              ...
              <>
                ...
                >
                  <div
                    className={`${isMobile ? "w-6 h-6" : "w-8 h-8"} flex items-center justify-center text-[#f4e8c1] bg-[#1c1c1c] rounded-lg border border-[#333333] shadow-inner transition-all duration-300 group-hover:border-[#444444] hover:text-pink-400 hover:border-[#444444] hover:shadow-[0_0_8px_rgba(244,114,182,0.4)]`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
        ...
        <div className="transition-all duration-300 ease-in-out px-6 max-h-[500px] opacity-100">
          <div className="space-y-1 my-2">
            {!isCollapsed ? (
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 flex-shrink-0 mr-3 flex items-center justify-center text-[#f4e8c1] bg-[#1c1c1c] rounded-lg border border-[#333333] shadow-inner transition-all duration-300 group-hover:border-[#444444] group-hover:text-pink-400 group-hover:shadow-[0_0_8px_rgba(244,114,182,0.4)]">
                ...
                <div className="flex flex-col justify-center">
                  <span
                    className={`magical-text whitespace-nowrap overflow-hidden text-ellipsis block text-xs md:text-sm text-[#f4e8c1] group-hover:text-pink-400 transition-colors duration-300 ${serifFontClass}`}
                  >
                    {character.name
                            ...
                            >
                              <div className="flex items-center">
                                ...
                                <button
                                  ...
                                  className="ml-2 w-4 h-4 flex items-center justify-center text-[#a18d6f] hover:text-[#f472b6] transition-all duration-300 rounded-full hover:bg-[#333]/50 group/info"
          ...
          {!isCollapsed ? (
            <div className="px-2 py-2">
              ...
              <div className="flex justify-between mt-3 px-0.5">
                ...
                <div className="flex items-center">
                  <span className="text-[10px] md:text-xs font-medium bg-gradient-to-r from-pink-400 to-pink-300 bg-clip-text text-transparent">
