    ...
    <div className="mb-3">
      ...
      >
        <svg
          ...
          className={`h-4 w-4 text-[#a18d6f] group-hover:text-[#f9a8d4] transition-transform duration-300 ${
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm text-[#a18d6f] group-hover:text-[#f9a8d4] ${fontClass}`}>
      ...
      >
        <div className="bg-[#1f1d1a]/80 border border-[#534741]/40 rounded-lg p-4 backdrop-blur-sm">
          <div className={`text-sm text-[#f9a8d4] leading-relaxed whitespace-pre-wrap ${serifFontClass}`}>
            {thinkingContent}
          </div>
        </div>
      </div>
