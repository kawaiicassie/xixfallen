  ...
  return (
    <div className={`p-2 sm:p-4 ${fontClass} relative`}>
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-pink-500/10 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-gradient-to-tr from-pink-500/10 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="relative z-10">
        <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
          <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-pink-500/20 to-pink-600/30 flex items-center justify-center border border-pink-500/30 shadow-lg shadow-pink-500/10">
          ...
          <h3 className={`text-base sm:text-lg font-semibold ${serifFontClass} bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-pink-400 to-pink-300`}>
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-4 sm:mb-6">
          <div className="flex-1 relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <input
              type="text"
              value={newSymbol}
              onChange={(e) => setNewSymbol(e.target.value)}
              placeholder={t("characterChat.enterSymbol")}
              className="relative z-10 w-full px-3 py-2 bg-gradient-to-br from-[#1a1816] via-[#252220] to-[#1a1816] text-[#eae6db] rounded-lg border border-[#534741]/60 focus:border-pink-500/60 focus:outline-none focus:ring-2 focus:ring-pink-500/20 transition-all duration-300 hover:border-[#534741] backdrop-blur-sm shadow-inner text-sm sm:text-base"
            />
          </div>
          <button
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-transparent rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="space-y-3 sm:space-y-4">
          {symbolColors.map(({ symbol, color }) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500/5 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <div className="relative z-10 flex items-center gap-2 sm:gap-3">
                <div className="flex gap-1.5 sm:gap-2">
                  {getPredefinedColors(symbol).map((predefinedColor: string) => (
                    <button
                      key={predefinedColor}
                      className="relative group/color w-5 h-5 sm:w-6 sm:h-6 rounded-full border border-white/20 hover:scale-110 transition-transform shadow-lg hover:shadow-pink-500/20"
                ...
                <div className="relative">
                  <div
                    className="relative group/color w-6 h-6 sm:w-8 sm:h-8 rounded cursor-pointer border border-white/20 hover:scale-110 transition-transform shadow-lg hover:shadow-pink-500/20"
                  ...
                  {activeColorPicker === symbol && (
                    <div className="absolute right-0 top-full mt-2 z-50">
                      ...
                      <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-transparent rounded-lg blur-xl"></div>
